...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="section-container bg-accent/10">
      <motion.h2 
        ...
        viewport={{ once: true }}
      >
        <span className="bg-gradient-to-r from-cyan-400 to-blue-600 bg-clip-text text-transparent">联系我</span>
      </motion.h2>
      <motion.p 
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center">
              ...
              <div>
                ...
                <a href="mailto:yangjinfei001@gmail.com" className="text-text hover:text-primary transition-colors">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <a href="tel:+8613008857268" className="text-text hover:text-primary transition-colors">
                  13008857268
                </a>
              </div>
            </div>
        ...
        >
          ...
          {isSubmitted ? (
            ...
            >
              ...
              <h4 className="text-xl font-medium text-primary mb-2">消息已发送</h4>
              <p className="text-secondary">感谢您的留言，我会尽快回复您！</p>
            </motion.div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-secondary text-sm mb-1">姓名</label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              <div>
                <label htmlFor="email" className="block text-secondary text-sm mb-1">邮箱</label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              <div>
                <label htmlFor="message" className="block text-secondary text-sm mb-1">消息</label>
                <textarea
                  id="message"
                  name="message"
